...
class AfrinicIpsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        \DB::table("iprange_afrinic")->truncate();
        $file = new SplFileObject('database/csv/ipv4_afrinic.csv');
        $file->setFlags(
...
//            ];
            ...
            \DB::table("iprange_afrinic")->insert($list);
        }
