...
class RipeIpsTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        \DB::table("iprange_ripe")->truncate();
        $file = new SplFileObject('database/csv/ipv4_ripe.csv');
        $file->setFlags(
...
//            ];
            ...
            \DB::table("iprange_ripe")->insert($list);
        }
